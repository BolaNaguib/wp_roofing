...
?> <!-- CTA --><!-- START section --><section id="<?php echo $section_id;?>" class="section_type-cta <?php if($full_width): ?> full-width <?php else: ?> <?php endif; ?> <?php if ($section_theme) : ?> section_theme-blue <?php else : ?> <?php endif; ?>"><!-- START uk-container --><div class="uk-container"><!-- START uk-text-center --><div class="uk-text-center"><h2 class="uk-margin-remove"><?php echo $cta_content ;?> <a href="tel:<?php echo $phone ;?>"><?php echo $phone_display ;?></a></h2></div><!-- END uk-text-center --></div><!-- END uk-container --></section><!-- END section -->